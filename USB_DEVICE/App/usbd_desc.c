...
/* --- Composite Configuration Descriptor ---
   This descriptor defines two interfaces:
     Interface 0: Mouse HID (1 endpoint)
     Interface 1: Custom HID (2 endpoints)
*/
...
__ALIGN_BEGIN uint8_t USBD_Composite_CfgDesc[COMPOSITE_CONFIG_DESC_SIZE] __ALIGN_END = {
  ...
  0x81,                               /* bEndpointAddress: IN endpoint (address 1) */
  ...
  0x07,                               /* bLength: Endpoint Descriptor size */
  USB_DESC_TYPE_ENDPOINT,             /* bDescriptorType: Endpoint */
  0x82,                               /* bEndpointAddress: IN endpoint (address 2) */
  0x03,                               /* bmAttributes: Interrupt */
  ...
  0x07,                               /* bLength: Endpoint Descriptor size */
  USB_DESC_TYPE_ENDPOINT,             /* bDescriptorType: Endpoint */
  0x02,                               /* bEndpointAddress: OUT endpoint (address 2) */
  0x03,                               /* bmAttributes: Interrupt */
  0x08, 0x00,                         /* wMaxPacketSize: 8 bytes */
  0x0A                                /* bInterval: 10 ms */
};
...
/* Callback implementations for string descriptors.
   USBD_GetString is assumed to be provided by the middleware – if not, implement a simple version. */
...
/* Structure grouping string descriptor callback functions */
